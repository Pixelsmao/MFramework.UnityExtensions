...
namespace MFramework.Extensions.UnityComponent
{
    public static class TerrainExtensions
    {
        ...
        public static int[] GetHeightmapIndex(this Terrain terrain, Vector3 point) {
        ...
        public static Vector3 GetRelativePosition(this Terrain terrain, GameObject go) {
        ...
        public static float GetPointHeight(this Terrain terrain, Vector3 point, bool vertex = false) {
        ...
        /// <returns></returns>
        public static float[,] GetHeightMap(this Terrain terrain, int xBase = 0, int yBase = 0, int width = 0,
            int height = 0) {
        ...
        public static void Rise(this Terrain terrain, Vector3 point, float opacity, int size, bool amass = true) {
            int[] index = GetHeightmapIndex(terrain, point);
        ...
        /// <param name="size">笔刷大小</param>
        /// <param name="amass">当笔刷范围内其他点的高度已经高于笔刷中心点时是否同时提高其他点的高度</param>
        public static void Rise(this Terrain terrain, int[] index, float opacity, int size, bool amass = true) {
            TerrainData tData = terrain.terrainData;
        ...
        public static void Sink(this Terrain terrain, Vector3 point, float opacity, int size, bool amass = true) {
            int[] index = GetHeightmapIndex(terrain, point);
        ...
        /// <param name="size">笔刷大小</param>
        /// <param name="amass">当笔刷范围内其他点的高度已经低于笔刷中心点时是否同时降低其他点的高度</param>
        public static void Sink(this Terrain terrain, int[] index, float opacity, int size, bool amass = true) {
            TerrainData tData = terrain.terrainData;
        ...
        /// <param name="size">笔刷大小</param>
        public static void Smooth(this Terrain terrain, Vector3 point, float opacity, int size) {
            int[] index = GetHeightmapIndex(terrain, point);
        ...
        /// <param name="opacity">平滑灵敏度，值介于 [0.05,1] 之间</param>
        /// <param name="size">笔刷大小</param>
        public static void Smooth(this Terrain terrain, int[] index, float opacity, int size) {
            TerrainData tData = terrain.terrainData;
            ...
            // 利用笔刷4角的高度来计算平均高度
            float avgHeight = (heights[0, 0] + heights[0, width - 1] + heights[height - 1, 0] +
                               heights[height - 1, width - 1]) / 4;
        ...
        public static void Flatten(this Terrain terrain, float height) {
            TerrainData tData = terrain.terrainData;
        ...
        public static void SetHeights(this Terrain terrain, float[,] heights, int xBase = 0, int yBase = 0) {
        ...
        /// <param name="amass">当笔刷范围内其他点的高度已经高于笔刷中心点时是否同时提高其他点的高度</param>
        private static void ExpandBrush(float[,] heights, float deltaHeight, float initHeight,
            int row, int column,
            bool amass) {
            // 高度限制
